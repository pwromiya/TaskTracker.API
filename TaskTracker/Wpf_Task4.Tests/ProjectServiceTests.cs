...
public class ProjectServiceTests
{
    ...
    {
        // Act
        var result = await _service.CreateProjectAsync("Test", "Desc", 1);
    ...
    public async Task UpdateProjectAsync_Should_Update_Name()
    {
        ...
        // Act
        await _service.UpdateProjectAsync(1, "New", null, 1);
    ...
    public async Task UpdateProjectAsync_Should_Throw_When_NotOwner()
    {
        ...
        await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
            _service.UpdateProjectAsync(1, "New", null, 1));
    }
    ...
    public async Task DeleteProjectAsync_Should_Remove_Project()
    {
        ...
        // Act
        await _service.DeleteProjectAsync(1, 1);
